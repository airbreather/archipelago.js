import { itemsHandling } from '@airbreather/archipelago-api/constants';

import { targetVersion } from '../constants';
...
export interface ConnectionOptions {
	 ...
	 *
	 * Value is an integer bitflag combination of values that is documented in {@link itemsHandling}.
	 * @default {@link itemsHandling.all}
