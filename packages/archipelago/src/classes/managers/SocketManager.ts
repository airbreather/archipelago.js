import type { ClientPacket, RoomInfoPacket, ServerPacket } from '@airbreather/archipelago-api';

import { SocketError } from '../../errors';
import type { SocketEvents } from '../../events/SocketEvents';
...
export class SocketManager extends EventBasedManager<SocketEvents> {
	 ...
	 */
	public send(...packets: ClientPacket[]): this {
		if (this.#socket) {
