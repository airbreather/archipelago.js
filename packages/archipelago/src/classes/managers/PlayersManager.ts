import type { clientStatus, Player as NetworkPlayer, Slot as NetworkSlot } from '@airbreather/archipelago-api';

import type { PlayerEvents } from '../../events/PlayerEvents';
import { Client } from '../Client';
import { Player } from '../Player';
import { EventBasedManager } from './EventBasedManager';

/** A type alias for any known client status. See {@link clientStatus} for more information. */
