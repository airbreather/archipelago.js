import type { DataPackage, DataPackageCache, GamePackage, GetDataPackagePacket } from '@airbreather/archipelago-api';
...
export class DataPackageManager {
	...
	public lookupItemName(game: string, id: number, fallback = true): string | undefined {
	...
	public lookupLocationName(game: string, id: number, fallback = true): string | undefined {
