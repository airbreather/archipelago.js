import type { DataStorageOperation, JSONValue } from '@airbreather/archipelago-api';
 ...
 */
export class IntermediateDataOperation<T extends JSONValue> {
	 ...
	 */
	public replace(value: JSONValue): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public add(value: number | JSONValue[]): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public remainder(value: number): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public leftShift(value: number): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public rightShift(value: number): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public remove(value: JSONValue): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public pop(value: JSONValue): this {
	 ...
	 * @param value A value for the operation to apply against the current data storage value.
	 */
	public update(value: JSONValue): this {
	...
	public async commit(awaitReply = false): Promise<T | void> {
		const _uuid = uuid();
		const request = {
			cmd: 'Set',
		...
		const [response] = await this.#client.socket.wait('setReply', (packet) => 'uuid' in packet && packet.uuid === _uuid);
