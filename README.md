# ![archipelago.js Icon](./assets/icon_small.png) archipelago.js (@airbreather fork)

![GitHub License](https://img.shields.io/github/license/airbreather/archipelago.js?style=flat-square)
![Types](https://img.shields.io/npm/types/%40airbreather%2Farchipelago.js?style=flat-square)
![NPM Version](https://img.shields.io/npm/v/%40airbreather%2Farchipelago.js?style=flat-square)
![NPM Downloads](https://img.shields.io/npm/dm/%40airbreather%2Farchipelago.js?style=flat-square)
...
Install via `npm install @airbreather/archipelago.js` (or via your preferred package manager's flavor).

## Starting Guide

Check out the intro documentation [here](https://archipelagojs.airbreather.dev/stable/documents/Introduction.html)!

## API Documentation

The full API documentation is located [here](https://archipelagojs.airbreather.dev). Please be sure to reference it
...
```bash
git clone https://github.com/airbreather/archipelago.js
cd archipelago.js
...
Currently, the automated tests for this library are very minimal. Most testing in browser, Node, Deno, and Bun are done
